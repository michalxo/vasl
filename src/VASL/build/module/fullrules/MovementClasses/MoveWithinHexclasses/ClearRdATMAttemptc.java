...
public class ClearRdATMAttemptc implements MoveWithinHexi {
    ...
    public boolean MoveAllOK() {
        ...
        //MessageBox.Show("Trying to clear AT Mines in  . . . " + hexclickedvalue.getName() + " at a cost of " + Double.toString(MFCost) + " MF");
    ...
    public void MoveUpdate() {
        ...
        if (ClearanceResultvalue == "Cleared") {
            ...
            // LOCtouse.ATMines = 0 :LOCtouse.ATMinesVisible = False NEED TO MANAGE
        }
    ...
    /*private boolean Wiretest(ByRef movingunit As ObjectClassLibrary.ASLXNA.PersUniti) {
        ...
        'If movingunit.BasePersUnit.FirstSWLink = SWtoCheck.OBSW_ID Then movingunit.BasePersUnit.FirstSWLink = 0
        'If movingunit.BasePersUnit.SecondSWlink = SWtoCheck.OBSW_ID Then movingunit.BasePersUnit.SecondSWlink = 0
        'SWtoCheck.Owner = 0
        dropchoice = True
        End If
