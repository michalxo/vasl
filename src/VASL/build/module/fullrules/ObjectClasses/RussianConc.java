...
public class RussianConc implements PersUniti{
    ...
    public RussianConc (String PassHexname, int PassScenario, Hex PassHex, Location Passhexlocation, Constantvalues.AltPos PasshexPosition, double PassLevelinHex,  boolean PassCX,
