...
public class German338c implements PersUniti{
    ...
    public German338c (String PassHexname, int PassScenario, Hex PassHex, Location Passhexlocation, Constantvalues.AltPos PasshexPosition, double PassLevelinHex,  boolean PassCX,
