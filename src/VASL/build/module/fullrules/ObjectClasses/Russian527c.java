...
public class Russian527c implements PersUniti{
    ...
    public Russian527c (String PassHexname, int PassScenario, int PassHexnum, Constantvalues.Location Passhexlocation, Constantvalues.AltPos PasshexPosition, double PassLevelinHex, int PassLOCIndex, boolean PassCX,
