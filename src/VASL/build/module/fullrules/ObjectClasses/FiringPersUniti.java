...
public  interface FiringPersUniti{
    ...
    boolean getIsCX();
    void setIsCX(boolean value);
    boolean getIsEncirc();
    void setIsEncirc(boolean value);
    int getBaseFP();
    int getBaseRange();
    boolean getAssF();
    double getCombatFP();
    ...
    LinkedList<SuppWeapi> FiringMGs = new LinkedList<SuppWeapi>();
        ...
        void ResetCombatFP();
        void UpdateCombatStatus(PersUniti firingunit, Constantvalues.CombatStatus NewCombatStatus, int ROFdr);
}
