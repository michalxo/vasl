...
public class GermanDummyc implements PersUniti{
    ...
    public GermanDummyc (String PassHexname, int PassScenario, Hex PassHex, Location Passhexlocation, Constantvalues.AltPos PasshexPosition, double PassLevelinHex,  boolean PassCX,
