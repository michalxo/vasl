...
public class German467c implements PersUniti {
    ...
    public German467c (String PassHexname, int PassScenario, int PassHexnum, int Passhexlocation, Constantvalues.AltPos PasshexPosition, double PassLevelinHex, int PassLOCIndex, boolean PassCX,
