...
public class UnitHeroHardensc  implements  StatusChangei{
    ...
    public boolean Takeaction(PersUniti TargParent) {
        ...
        //  create the hero
        StatusChangei HeroCreate = new UnitHeroCreationc();
        HeroCreate.Takeaction(NewUnit);
        return true;
    }
