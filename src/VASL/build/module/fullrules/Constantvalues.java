...
public class Constantvalues {
    ...
    public static enum AltPos {AboveWire, WallAdv, InFoxhole, InTrench, OtherTerrainInHex, InSanger, AbovePanji, OnRoad, CrestStatus0,
        CrestStatus1, CrestStatus2, CrestStatus3, CrestStatus4, CrestStatus5, ExitedEntrench, ExitedCrest0, ExitedCrest1, ExitedCrest2,
        ExitedCrest3, ExitedCrest4, ExitedCrest5, Rider, Passenger, WACrestStatus0, WACrestStatus1, WACrestStatus2, WACrestStatus3,
        WACrestStatus4, WACrestStatus5, None, FailsandEnds, Fails, Smokeplaced}
    ...
    public static enum MovementStatus {Moved, TI, Waded, HumanWave, BanzaiCharge, AssaultMoving, Moving, Wading, AssaultMoved, FirstDash,
        SecondDash, Dashed, Labour1, Labour2, Advanced, Connecting, NotMoving}
    ...
    public enum Location {Ocean, OpenGround, River, Marsh, Brush, Streamshallow, Ford, PineWoods, Woods, Crag, Airfield, Mudflats, Orchard, OrchardPavedRoad, OrchardUnpavedRoad,
        ...
        FortWoodGrd, FortWood1st, FortWood2nd, FortWood3rd,  Pill1571, Pill1572, Pill1573, Pill1574, Pill1575, Pill1570, Pill1351, Pill1352, Pill1353, Pill1354, Pill1355, Pill1350, Pill2351,
        Pill2352, Pill2353, Pill2354, Pill2355, Pill2350, Pill2571, Pill2572, Pill2573, Pill2574, Pill2575, Pill2570, Pill3351, Pill3352, Pill3353, Pill3354,  Pill3355, Pill3350, Pill3571, Pill3572,
        Pill3573,  Pill3574, Pill3575, Pill3570, Pill2461, Pill2462, Pill2463 , Pill2464, Pill2465, Pill2460, Pill1461, Pill1462, Pill1463, Pill1464, Pill1465, Pill1460, Bombprf,  Cave146, CaveH46,
        Cave146LM1,  CaveH46LM1, Cave146L0, CaveH46L0, Cave146L1, CaveH46L1, Cave146L2, CaveH46L2,  Cave146L3, CaveH46L3, Cave146L4, CaveH46L4, StBr14,  StBr25, StBr30, WdBr14, WdBr25, WdBr30,
        SStBr14, SStBr25, SStBr30, SWdBr14, SWdBr25, SWdBr30, PoBr14, PoBr25, PoBr30,  FoBr,  WoodsTB, MineTB, StoneRubbleTB, PineWTB, JungleTB , DenseJungleTB, DebrisTB, WoodRubbleTB,
        WoodRubbleFallTB, StoneRubbleFallTB, OneFactRooflessMan, Trench}
    ...
    public enum Hexside{GullyUp, GullyDown, GullyUpSlope, GullyDownSlope, GullyUpWire, GullyDownWire, AttWoodsGullyUp, AttWoodsGullyDown, AttPWdsGullyUp, AttPWdsGullyDn, GullyUpHedge, GullyDownHedge,
        ...
        CrestUpSlopeDwnPvRd , CrestUpTrail, CrestDownTrail, Cave, TrailBreak, Roadblock0, Roadblock1, Roadblock2, Roadblock3, Roadblock4, Roadblock6, CrestNarrowPaved, CrestUpNarrowPaved, CrestDownNarrowPaved,
    ...
    public enum PersUnitResult{Breaks, Dies, Pins, Reduces, ReducesBreaks, DMs, Fanatics, Hardens, Berserks, Surrenders, Replaces, ReplacesReducesBreaks, Wounds, Substitutues, ReplacesDMs, Disrupts, HeroCreation,
        ...
        RevealAllDummy, HeroicLdrCreation, HeroicLdrHardens, ReducesDMs, GoodOrders}
    ...
    public enum UMove {StairsUp, StairsDown, FeatureEnter, FeatureExit, HexNew, DblTime, RoadBonus, DbT_RB, OTRate, TerrainRate, Roadrate, bypassrate, extrabypassrate, creststatusrate, INrate,
        HumanWave, Banzai, EnterFoxhole, ExitFoxhole, EnterPillbox, ExitPIllbox, EnterTrench, ExitTrench, EnterWire, ExitWire, Assault, Dash, EnterVehicle, ExitVehicle, Riding, ThrowSmoke,
        ThrowSmokeSame, ThrowSmoke0, ThrowSmoke1, ThrowSmoke2, ThrowSmoke3, ThrowSmoke4, ThrowSmoke5, ThrowSmokeDown, ThrowSmokeUp, ThrowSmokeGround, Fails, FailsandEnds, ClearRubble, ClearMine,
        ClearRoadATMine, ClearWire, ClearFlame, ClearSetDC, ClearEnterRubble, ClearEnterMines, ClearRdBlk, ClearEnterRubble0, ClearEnterRubble1, ClearEnterRubble2, ClearEnterRubble3,
        ClearEnterRubble4, ClearEnterRubble5, ClearEnterMines0, ClearEnterMines1, ClearEnterMines2, ClearEnterMines3, ClearEnterMines4, ClearEnterMines5, ClearRdBlk0, ClearRdBlk1, ClearRdBlk2,
        ClearRdBlk3, ClearRdBlk4, ClearRdBlk5, EnterWA, CrestStatusRateWA, StairsDownWA, StairsUpWA, DoSearch, DoPlaceDC, EnterTerrain, ExitTerrain, EnterConnectingTrench, EnterConnectingCellar,
        EnterConnectingBldg, EnterViaConnection, EnterConnectingPill, CrestStatus0, CrestStatus1, CrestStatus2, CrestStatus3, CrestStatus4, CrestStatus5, ExitCrestStatus, WACrestStatus0, WACrestStatus1,
        WACrestStatus2, WACrestStatus3, WACrestStatus4, WACrestStatus5, Clearance, ClaimWallAdv, ForfeitWA, Search, DropSW, RecoverSW, RecoverSWBrk, PlaceDC, EnterConnectingBldgLevel1,
        EnterConnectingBldgLevel2, EnterConnectingBldgLevel3, EnterConnectingBldgLevel4, EnterConnectingBldgLevelm1, BeneathBridge}
    public enum ToDo {Nothing}
}
