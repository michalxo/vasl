...
public class Constantvalues {
    ...
    public enum LOS{HexGrain, AltHexGrain, VertHexGrain, NoHexGrain, HorizontalHexGrain}
    public enum Location {Ocean, OpenGround, River, Marsh, Brush, Streamshallow, Ford, PineWoods, Woods, Crag, Airfield, Mudflats, Orchard, OrchardPavedRoad, OrchardUnpavedRoad,
        ...
        bridgetype,  Marshtype,  ShallowStreamtype, DeepStreamtype, WaterObstacletype, Blazetype, towertype, Roadtype, OBAtype, HardSurftype, HasStairs, Burnabletype,  Roof, BuildingGroundlevel,
        Building1stLevel, Building2ndLevel, Building3rdLevel, Cellar, InCave,  BeneathBridge, Sewer, BeneathPier, Tunnel, Huts, BunkUnder, FortStoneGrd, FortSTone1st, FortStone2nd, FortSTone3rd,
