            ...
            for (String fromPieceID : links.keySet()) {
                ...
                if (fromPiece != null &&
                    ...
                    for (String s : toPieceIDs) {
                        ...
                        if (toPiece != null &&
                           DoubleBlindViewer.isSpotted(toPiece) &&(toPiece.getProperty(Properties.INVISIBLE_TO_ME) == null || Boolean.FALSE.equals(toPiece.getProperty(Properties.INVISIBLE_TO_ME))) &&
